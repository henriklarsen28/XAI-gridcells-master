...
if __name__ == "__main__":
    ...
    config = {
        ...
        "policy_load_path": f"./models/transformers/feasible-lake-1351/actor/policy_network_1000.pth",
        "critic_load_path": "./models/transformers/feasible-lake-1351/critic/critic_network_1000.pth",
